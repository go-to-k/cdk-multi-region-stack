...
Overrides the CloudFormation stack names of the twins/groups, instead of the default shared name (`<stackName>` for a region's twin, `<stackName>-<group>` for a group).
